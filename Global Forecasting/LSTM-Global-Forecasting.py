...
def get_dataset_params(dataset_name = 'cif-12'):
    ...
    if dataset_name == 'nn5':
        ...
        features = pd.read_csv("/home/anoshad.t1@gigroup.local/workarea/es_analysis/ExperimentLSTM/features/nn5 cnn/Features_nn5_CNN_16.csv",sep=',', header=None)
...
### Network Structure
            ...
            lstm1=keras.layers.LSTM(128,activation='linear',return_sequences=True)(input_layer)
            lstm2=keras.layers.LSTM(64,activation='linear',return_sequences=True)(lstm1)
...
def nn5(AEName="CNN", Dim=16, run=1):
    
    ds_names = [AEName, [5, 15, 25, 35, 50], [20, 40, 60, 80, 100], Dim]
    file_mode = 'w'
    csv_file = "LSTM_NN5_results_"+AEName+"_"+str(Dim)+".csv"
